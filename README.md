**school-management-nestjs-graphql** is a backend api for Task Management app. Built with NestJs as a framework of Node.js and PostgreSQL as a database which has [features](#features).
